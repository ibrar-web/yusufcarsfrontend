...
const INQUIRY_ROUTE = apiRoutes.website.inquries;
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (uploadedFile) {
        ...
        multipart.append("attachment", uploadedFile);

        const response = await apiPost<InquiryResponse>(
          INQUIRY_ROUTE,
          multipart,
          {
        ...
        inquiryId = response?.data?.id ?? null;
      } else {
        const response = await apiPost<InquiryResponse>(
          INQUIRY_ROUTE,
          basePayload,
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      >
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          ...
          <p
            className="font-['Roboto'] text-white/80 max-w-2xl"
            style={{ fontSize: "20px", lineHeight: 1.6 }}
          >
            We usually reply within a few hours. Choose the best way to reach
            us.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="bg-gradient-to-br from-[#0F172A] to-[#1E293B] border-0 rounded-[16px] hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <h3
                  className="font-['Inter'] font-semibold text-white text-center mb-3"
                  style={{ fontSize: "16px" }}
                >
                  Phone
                </h3>
                <p
                  className="font-['Roboto'] text-white/80 text-center mb-6"
                  style={{ fontSize: "15px" }}
                >
                  +44 20 1234 5678
                </p>
            ...
            <Card className="bg-gradient-to-br from-[#0F172A] to-[#1E293B] border-0 rounded-[16px] hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <Button
                  onClick={() =>
                    window.open(
                      "https://www.google.com/maps/search/?api=1&query=123+Auto+Street+London+EC1A+1BB",
                      "_blank"
                    )
                  }
                  className="w-full border-2 border-white/20 bg-transparent text-white hover:bg-white/10 rounded-full h-auto py-3"
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between flex-wrap gap-6">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4
                      className="font-['Inter'] font-semibold text-[#0F172A] mb-1"
                      style={{ fontSize: "16px" }}
                    >
            ...
            <Card className="bg-white border border-[#E5E7EB] rounded-[16px] shadow-sm">
              <CardContent className="p-8 md:p-10">
                {!isSuccess ? (
                  <>
                    <h2
                      className="font-['Inter'] font-semibold text-[#0F172A] mb-6"
                      style={{ fontSize: "24px" }}
                    >
                      Send Us a Message
                    </h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        <Label
                          htmlFor="name"
                          className="font-['Roboto'] text-[#0F172A] mb-2 block"
                        >
                          Full Name *
                        </Label>
                        <Input
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="supplier-onboarding">
                              Supplier Onboarding
                            </SelectItem>
                      ...
                      <div>
                        ...
                        {!uploadedFile ? (
                          ...
                          >
                            ...
                            <p
                              className="font-['Roboto'] text-[#64748B] mb-1"
                              style={{ fontSize: "14px" }}
                            >
                      ...
                      <div className="flex items-start gap-3 p-4 bg-[#F8FAFC] rounded-[16px]">
                        ...
                        <label
                          htmlFor="gdpr"
                          className="font-['Roboto'] text-[#64748B] cursor-pointer"
                  ...
                  <div className="py-12 text-center">
                    ...
                    <p
                      className="font-['Roboto'] text-[#64748B] mb-8 max-w-md mx-auto"
                      style={{ fontSize: "16px", lineHeight: 1.6 }}
                    >
                      Thank you for contacting us. We've received your message
                      and will respond within 2 hours during business hours.
                    </p>
            ...
            <Card className="bg-white border border-[#E5E7EB] rounded-[16px] overflow-hidden">
              <div className="grid md:grid-cols-2">
                ...
                <div className="bg-gradient-to-br from-[#0F172A] to-[#1E293B] p-8">
                  ...
                  <p
                    className="font-['Roboto'] text-white/80 mb-6"
                    style={{ fontSize: "16px", lineHeight: 1.6 }}
                  >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p
                        className="font-['Roboto'] text-white/80"
                        style={{ fontSize: "14px" }}
                      >
      ...
      <section className="py-16 bg-[#F8FAFC]">
        <div className="max-w-[1200px] mx-auto px-6">
          <Card className="bg-gradient-to-br from-[#0F172A] to-[#1E293B] border-0 rounded-[16px] shadow-2xl">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <p
                className="font-['Roboto'] text-white/80 max-w-2xl mx-auto mb-8"
                style={{ fontSize: "18px", lineHeight: 1.6 }}
              >
                Our support team is available Mon–Fri, 9:00–18:00. Get instant
                help or schedule a call.
              </p>
      ...
      <Dialog open={isChatOpen} onOpenChange={setIsChatOpen}>
        <DialogContent className="sm:max-w-[500px] bg-white border-0 rounded-[16px] p-0 overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <DialogDescription
                    className="font-['Roboto'] text-white/70"
                    style={{ fontSize: "14px" }}
                  >
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <div className="bg-white rounded-[12px] p-4 shadow-sm border border-[#E5E7EB]">
                  ...
                  >
                    Hello! 👋 Welcome to PartsQuote support. How can we help you
                    today?
                  </p>
                </div>
                <p
                  className="font-['Roboto'] text-[#64748B] mt-1.5 ml-2"
                  style={{ fontSize: "12px" }}
                >
                  Just now
                </p>
          ...
          <div className="p-4 bg-white border-t border-[#E5E7EB]">
              ...
              <Input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter" && chatMessage.trim()) {
                    toast.success(
                      "Message sent! A support agent will respond shortly."
                    );
                    setChatMessage("");
                  }
                }}
            ...
            <p
              className="font-['Roboto'] text-[#64748B] text-center mt-3"
              style={{ fontSize: "12px" }}
            >
