...
export function RoleSelectionDialog({ open, onOpenChange, onSelectRole, onNavigate }: RoleSelectionDialogProps) {
  ...
  return (
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[420px] bg-[#0F172A] border-[#334155]">
        <DialogHeader>
          <DialogTitle className="font-['Inter'] text-xl text-white">Who are you?</DialogTitle>
        ...
        <div className="grid gap-2 py-2">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0F172A] group-hover:bg-[#F02801] transition-all">
                <User className="h-5 w-5 text-[#94A3B8] group-hover:text-white transition-all" strokeWidth={2} />
              </div>
              <div className="flex-1">
                <h3 className="font-['Inter'] text-white text-sm mb-0.5">I'm a User</h3>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0F172A] group-hover:bg-[#F02801] transition-all">
                <Building2 className="h-5 w-5 text-[#94A3B8] group-hover:text-white transition-all" strokeWidth={2} />
              </div>
              <div className="flex-1">
                <h3 className="font-['Inter'] text-white text-sm mb-0.5">I'm a Supplier</h3>
                <p className="text-xs font-['Roboto'] text-[#94A3B8]">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0F172A] group-hover:bg-[#F02801] transition-all">
                <Shield className="h-5 w-5 text-[#94A3B8] group-hover:text-white transition-all" strokeWidth={2} />
              </div>
              <div className="flex-1">
                <h3 className="font-['Inter'] text-white text-sm mb-0.5">I'm an Admin</h3>
                <p className="text-xs font-['Roboto'] text-[#94A3B8]">
