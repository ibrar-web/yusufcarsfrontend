                ...
                {[
                  ...
                  >
                    <span className="flex items-center gap-2">
                      {filter.label}
                      <span
                        className={`inline-flex items-center justify-center min-w-[24px] h-6 px-2 rounded-md font-['Roboto'] ${
                          inquiryFilter === filter.id
            ...
            {filteredInquiries.map((inquiry, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center gap-3">
                  ...
                  <Badge
                    variant="outline"
                    className="border-[#E5E7EB] text-[#475569] font-['Roboto'] whitespace-nowrap"
                  >
                    {inquiry.category}
                  </Badge>
