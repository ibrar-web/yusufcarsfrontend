    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-primary/10 flex items-center justify-center p-6">
      <div className="w-full max-w-[480px]">
        ...
        <button
          ...
          className="flex items-center gap-2 mb-8 hover:opacity-80 transition-opacity mx-auto"
        >
          <div className="h-12 w-12 bg-primary rounded-xl flex items-center justify-center">
            <Car className="h-7 w-7 text-white" />
          </div>
          <span className="font-['Inter'] font-bold text-2xl">PartsQuote</span>
        </button>
        ...
        <Card className="shadow-2xl relative">
          <button
            onClick={() => onNavigate("home")}
            className="absolute top-4 right-4 p-2 rounded-lg hover:bg-muted-background transition-colors"
            aria-label="Close"
          >
