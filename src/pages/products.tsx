...
export function ProductsPage({ 
  ...
  const [requestSuccessDialogOpen, setRequestSuccessDialogOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              {categories.map((category) => (
                <button
                  ...
                  style={{ fontSize: "14px" }}
                >
                  <category.icon className={`h-4 w-4 transition-transform duration-300 ${
          ...
          <div className="mb-8">
            <p className="font-['Roboto'] text-[#64748B]" style={{ fontSize: "16px" }}>
              ...
              {selectedCategory !== "all" && (
                <span className="ml-2">
                  in <span className="font-semibold text-[#F02801]">{categories.find(c => c.id === selectedCategory)?.name}</span>
                </span>
              )}
            </p>
          </div>
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-['Inter'] font-semibold text-[#0F172A] mb-4" style={{ fontSize: "16px", lineHeight: 1.3 }}>
                    {product.name}
                  </h3>
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-20">
              ...
              <h3 className="font-['Inter'] font-semibold text-[#0F172A] mb-2" style={{ fontSize: "24px" }}>
                No products found
              </h3>
              <p className="font-['Roboto'] text-[#64748B]" style={{ fontSize: "16px" }}>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="font-['Inter'] font-semibold text-[#0F172A] mb-2" style={{ fontSize: "18px", lineHeight: 1.3 }}>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="font-['Inter'] font-bold text-[#0F172A]" style={{ fontSize: "24px" }}>
                      £{selectedProduct.price.toFixed(2)}
                    </span>
                    {selectedProduct.originalPrice > selectedProduct.price && (
                      <span className="font-['Roboto'] text-[#94A3B8] line-through" style={{ fontSize: "14px" }}>
              ...
              <div className="bg-[#FEF2F2] border-2 border-[#FECACA] rounded-xl p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-['Roboto'] text-[#64748B] mt-1" style={{ fontSize: "13px" }}>
                      Add this part to your basket and we'll help you find the best suppliers with competitive quotes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  onClick={() => {
                    onNavigate("chat");
                    toast.success("Order placed! Contact the supplier for details.");
                  }}
      ...
      <Dialog open={quoteConfirmDialogOpen} onOpenChange={setQuoteConfirmDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle className="font-['Inter'] text-[#0F172A]" style={{ fontSize: "24px" }}>
              ...
              <div className="flex gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    {requestedProduct.originalPrice > requestedProduct.price && (
                      <span className="font-['Roboto'] text-[#94A3B8] line-through" style={{ fontSize: "14px" }}>
              ...
              <div className="bg-[#FEF2F2] border-2 border-[#FECACA] rounded-xl p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-['Roboto'] text-[#64748B] mt-1" style={{ fontSize: "13px" }}>
                      Your request will be sent to multiple verified suppliers who will provide competitive quotes within 24 hours.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <Dialog open={requestSuccessDialogOpen} onOpenChange={setRequestSuccessDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <div className="flex flex-col items-center text-center mb-4">
              ...
              <DialogTitle className="font-['Inter'] font-bold text-[#0F172A] mb-2" style={{ fontSize: "28px" }}>
                Request Sent Successfully!
              </DialogTitle>
              
              <DialogDescription className="font-['Roboto'] text-[#64748B]" style={{ fontSize: "16px", lineHeight: 1.6 }}>
                Your quote request for <span className="font-semibold text-[#0F172A]">{requestedProduct?.name}</span> has been sent to our verified suppliers.
              </DialogDescription>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-4 my-4">
            ...
            <div className="bg-[#F8FAFC] border-2 border-[#E5E7EB] rounded-xl p-5">
              <h4 className="font-['Inter'] font-semibold text-[#0F172A] mb-3" style={{ fontSize: "16px" }}>
                What happens next?
              </h4>
              <ul className="space-y-2">
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-[#22C55E] flex-shrink-0 mt-0.5" />
                  <span className="font-['Roboto'] text-[#64748B]" style={{ fontSize: "14px", lineHeight: 1.6 }}>
            ...
            <div className="flex items-center justify-center gap-2 py-3 px-4 bg-[#FEF2F2] border border-[#FEE2E2] rounded-lg">
              ...
              <span className="font-['Roboto'] text-[#64748B]" style={{ fontSize: "13px" }}>
                Request ID: <span className="font-semibold text-[#F02801]">#{Math.random().toString(36).substr(2, 9).toUpperCase()}</span>
              </span>
            </div>
          </div>
            ...
            <>
              ...
              <div className="mt-3 space-y-2.5">
                ...
                <div className="relative h-36 rounded-lg overflow-hidden bg-[#F1F5F9]">
                  ...
                  />
                  {selectedProduct.originalPrice > selectedProduct.price && (
                    <Badge className="absolute top-2 right-2 bg-[#F02801] text-white" style={{ fontSize: "10px" }}>
                ...
                <div className="space-y-2">
                  <Badge className="bg-[#F1F5F9] text-[#64748B]" style={{ fontSize: "11px" }}>
                    {selectedProduct.category}
                  </Badge>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {[
                      ...
                      <div key={idx} className="flex items-center gap-1.5">
                        ...
                        <span className="font-['Roboto'] text-[#64748B]" style={{ fontSize: "11px" }}>
                          {feature}
                        </span>
                      </div>
                    ))}
                  ...
                  {/* Stock Status */}
                  <div className={`p-2 rounded-lg ${selectedProduct.inStock ? 'bg-[#F0FDF4] border border-[#86EFAC]' : 'bg-[#FEF2F2] border border-[#FECACA]'}`}>
                    <div className="flex items-center gap-1.5">
                      {selectedProduct.inStock ? (
                        <>
                          <CheckCircle className="h-3.5 w-3.5 text-[#22C55E]" />
                          <span className="font-['Roboto'] font-medium text-[#166534]" style={{ fontSize: "12px" }}>
                            In Stock
                          </span>
                        </>
                      ) : (
                        <>
                          ...
                          <span className="font-['Roboto'] font-medium text-[#991B1B]" style={{ fontSize: "12px" }}>
                            Out of Stock
                          </span>
                        </>
                      )}
